...
class CountDownLatchCustom {
	...
	/**
	 * CountDownLatch is initialized with given count. count specifies the number of
	 * events that must occur before latch is released.
	 */
	 ...
	 * - latch count has down to reached 0, or - unless the thread is interrupted.
	 */
