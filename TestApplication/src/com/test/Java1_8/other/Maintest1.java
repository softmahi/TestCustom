...
public class Maintest1 {
   ...
   public static void main(String args[]) {
      ...
      // Count empty strings
      List<String> strings = Arrays.asList("Gulam Jambum", "Gulam Jambum", "Gajar halawa", "Gajar halawa", "abcd","", "jkl","abc");
     ...
     // int i =0 ;
      for (String string : strings) {
    	  ...
    	  if(m.containsKey(string)) {
    		  System.out.println("adasdasd:"+string);
    		 // m.remove(string);
    		  i = (int) m.get(string);
    		  m.put(string,i+1);
      ...
      IntSummaryStatistics k =  integers.stream().mapToInt(x->x).summaryStatistics();
